...
**⛔ شارة الحساب تختفي بعد ٣ ثوانٍ** (`badgeUntil` بـtheme.json · `-1` تبقيها طول الفيديو):
اسمه مكتوب بالمنصة نفسها وبكرت النهاية، وبقاؤها فوق طول الفيديو ياكل المساحة اللي يحتاجها الرسم بـ`R_DOWN`.
