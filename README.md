...
| darija Whisper fine-tune *(if the default language is a hard dialect)* | better transcription than stock Whisper for Moroccan/Algerian darija | `video-editor/scripts/.models/`, machine-local, not committed |
